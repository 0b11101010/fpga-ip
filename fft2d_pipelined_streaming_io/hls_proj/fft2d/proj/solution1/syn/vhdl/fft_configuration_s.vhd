...
architecture arch of fft_configuration_s is
    --------------------- Component ---------------------
    component fft_configuration_s_core is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component fft_configuration_s_core
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
    ...
    status_data_V_din             <= (others => '0');
    status_data_V_write           <= '1';
