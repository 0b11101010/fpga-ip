set moduleName fft_configuration_1
set isTopModule 0
...
set Spec2ImplPortList { 
	...
	config_ch_data_V { ap_fifo {  { config_ch_data_V_dout fifo_data 0 8 }  { config_ch_data_V_empty_n fifo_status 0 1 }  { config_ch_data_V_read fifo_update 1 1 } } }
}
