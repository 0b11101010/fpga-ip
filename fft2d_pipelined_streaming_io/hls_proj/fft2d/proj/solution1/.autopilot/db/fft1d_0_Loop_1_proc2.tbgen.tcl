set moduleName fft1d_0_Loop_1_proc2
set isTopModule 0
...
set C_modelName {fft1d.0_Loop_1_proc2}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_V int 64 regular {fifo 0 volatile }  }
	{ xn int 64 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "xn", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ xn_din sc_out sc_lv 64 signal 1 } 
	{ xn_full_n sc_in sc_logic 1 signal 1 } 
	{ xn_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "xn_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "xn", "role": "din" }} , 
 	{ "name": "xn_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "xn", "role": "full_n" }} , 
 	{ "name": "xn_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "xn", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "xn", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	xn { ap_fifo {  { xn_din fifo_data 1 64 }  { xn_full_n fifo_status 0 1 }  { xn_write fifo_update 1 1 } } }
}
