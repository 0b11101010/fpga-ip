...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fft2d_top.autotvin_xn_data.dat"
         "c.fft2d_top.autotvin_xn_last.dat"
         "c.fft2d_top.autotvin_xk_data.dat"
         "c.fft2d_top.autotvin_xk_last.dat"
         "c.fft2d_top.autotvout_xk_data.dat"
         "c.fft2d_top.autotvout_xk_last.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fft2d_top.autotvout_xk_data.dat"
         "rtl.fft2d_top.autotvout_xk_last.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
