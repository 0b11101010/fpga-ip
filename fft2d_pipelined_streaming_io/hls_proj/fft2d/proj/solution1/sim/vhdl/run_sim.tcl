...
if {[file isfile fft2d_top.autotvin.dat]} {
	file delete -force fft2d_top.autotvin.dat
}

if {[file isfile fft2d_top.autotvout.dat]} {
	file delete -force fft2d_top.autotvout.dat
}
