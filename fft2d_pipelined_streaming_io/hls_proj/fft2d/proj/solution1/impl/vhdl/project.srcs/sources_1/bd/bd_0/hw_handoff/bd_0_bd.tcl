...
proc create_root_design { parentCell } {
  ...
  set xk [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 xk ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {400000000.0} \
   ] $xk

  set xn [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 xn ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {400000000.0} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
  ...
  set hls_inst [ create_bd_cell -type ip -vlnv EA:hls:fft2d_top:1.0 hls_inst ]

  # Create interface connections
  connect_bd_intf_net -intf_net hls_inst_xk [get_bd_intf_ports xk] [get_bd_intf_pins hls_inst/xk]
  connect_bd_intf_net -intf_net xn_0_1 [get_bd_intf_ports xn] [get_bd_intf_pins hls_inst/xn]
